            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Master Your Interviews <br /> with <span className="font-subheading italic">AI</span>
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Practice with our AI-powered mock interviews. Get real-time feedback, improve your skills, and boost your confidence for your next job interview.
                    </p>
                </div>
            </Container>
